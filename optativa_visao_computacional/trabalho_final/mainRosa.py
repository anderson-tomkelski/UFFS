...
vid = cv.VideoCapture('desafioEsteira/capsulaRosaTeste.mp4')
...
out = cv.VideoWriter('out/outputRosaTeste.avi', cv.VideoWriter_fourcc('M', 'J', 'P', 'G'), 30, (480, 270))
while(vid.isOpened()):
    #leitura do frame
    ret, frame = vid.read()
    ...
    ret, thresh = cv.threshold(grayFrame, 127, 255, 0)
